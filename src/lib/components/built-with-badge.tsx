export function BuiltWithBadge({ text }: { text: string }) {
  return (
    <a
      href="https://www.producthunt.com/posts/awesome-framer-motion-components"
      target="__blank"
      className="bg-slate-900 no-underline group mb-8 cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-md p-px text-xs font-semibold leading-6 text-white inline-block"
    >
